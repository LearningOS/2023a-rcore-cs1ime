...
{
    if ROOT_INODE.create_link(old_name, new_name)
    {
        0
    }
    else
...
{
    if ROOT_INODE.delete_link(name)
    {
        0
    }
    else 
...
impl File for OSInode {
    ...
    fn nlinks(&self) -> u32 
    {
        self.inner.exclusive_access().inode.nlinks()
    }
    ...
    fn get_ino(&self) -> u32
    {
        self.inner.exclusive_access().inode.get_ino()
    }
